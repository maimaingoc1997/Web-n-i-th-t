...
$query=mysqli_query($conn,"select * from tbl_danhmuc where id_danhmuc='$id_danhmuc'");
	...
	<form  enctype="multipart/form-data" method="post" class="form">
	 <table class="table" border="1" cellspacing="5" cellpadding="5">
		...
		<tr>
			...
			<td ><textarea name="ten_danhmuc" id="ten_danhmuc"  class="ten_danhmuc" rows="3" cols="120" ><?php echo $row['ten_danhmuc']; ?></textarea></td>
		</tr>

		<tr>
			<td colspan="2" align="center" ><input class="btnthem"type="submit" name="btn_update" value="Sửa danh mục"/></td>
		</tr>
		
</table>

<?php 
require './danhmuc_update.php';
// include '../incLogin.php';
