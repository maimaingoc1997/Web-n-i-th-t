    ...
    <form action="posts_add.php" enctype="multipart/form-data" method="post" class="form">
	 <table class="table table-bordered" border="1" cellspacing="5" cellpadding="5">
		...
		<tr>
			...
			<td ><textarea name="tieu_de" id="tieu_de" placeholder="Tiêu đề bài viết..." class="tieu_de" rows="2" cols="120"></textarea></td>
		</tr>
		<tr>
			<td>Nội dung </td>
			<td><textarea name="noi_dung" id="noi_dung" placeholder="Đây là nội dung..." class="noi_dung" rows="10" cols="120"></textarea></td>
		
			<tr>
			<td>Ảnh </td>
			<td class="AnhBLog"><input type="hidden" name="size" value="1000000">
				<input type="file" name="anh" class="anh"><br/><br/></td>
		</tr>
		</tr>
			<tr>
			<td>Thể loại </td>
			<td><textarea name="the_loai" id="the_loai" placeholder="Thể loại..." class="the_loai" rows="2" cols="120"></textarea></td>
		</tr>
		<tr>
			<td>Username </td>
			<td><textarea name="username" id="username" placeholder="Username..." class="username" rows="2" cols="120"></textarea></td>
		</tr>
		<tr>
        ...
        <input class="btnthem"type="submit" name="btn_submit" value="Thêm bài viết"
        style="
