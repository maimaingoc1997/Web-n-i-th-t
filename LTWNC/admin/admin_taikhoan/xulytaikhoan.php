...
<?php
  if(isset($_POST['capnhattaikhoan'])) {
    ...
    $sql_update_taikhoan = mysqli_query($conn, "UPDATE tbl_admin SET capquyen = '$xuly' 
                                        WHERE admin_id = '$id'");
  }
?>
<?php
    //  if(isset($_GET['quanly'])=='xoa') {
    //   $id = $_GET['id'];
    //   $sql_chitiet = mysqli_query($conn, "DELETE  FROM tbl_admin WHERE admin_id = '$id'");
    //   header("Location: xulytaikhoan.php");
    // }
    // header("Location: xulytaikhoan.php");
    ...
    <div class="row">
       <?php
          if(isset($_GET['quanly'])=='xemtaikhoan') {
            $id = $_GET['id'];
            $sql_chitiet = mysqli_query($conn, "SELECT * FROM tbl_admin WHERE admin_id = '$id'");
        ?> 
      ...
      <?php
        $sql_select = mysqli_query($conn, "SELECT * FROM tbl_admin");
      ?>
         <table class="table table-bordered">
          ...
          ?>
            <tr style="text-align:center">
              ...
              <!-- <a style="font-size: 14px;display:block;" href="?quanly=xoa&id=<?php echo $row_taikhoan['admin_id'] ?>" class="btn btn-danger mb-2">Xóa</a>  -->
              <a href="?quanly=xemtaikhoan&id=<?php echo $row_taikhoan['admin_id'] ?>" style="font-size: 14px;display:block" class="btn btn-primary">Xem tài khoản</a></td>
            </tr>
            <?php
            }
            ?>
