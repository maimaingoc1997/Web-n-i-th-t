...
<div class="wrapper">
  ...
  <div class="content-wrapper">    
    ...
    <form action="lienhe_xuly.php" enctype="multipart/form-data" method="post" class="form">
	<table class="table" >
  ...
  <?php
        ...
        while ($row = mysqli_fetch_array($result)) {
            echo "<trstyle='text-align: center;'>";
            echo "<td><h5>".$row['id_lienhe']."</h5></td>";
            echo "<td><h5 >".$row['email']."</h5></td>";
            echo "<td><p >".$row['noi_dung']."</p></td>";           
            echo '
                  <td><button class="btnDel"><a href="lienhe_delete.php?id_lienhe='.$row['id_lienhe'].'">Delete</a></button></td>';
            echo "</tr>";
        }
